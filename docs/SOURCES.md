...
| InsectCicada | Cicada 1, Long | Joseph Sardin | [bigsoundbank.com/cicada-1-long-s2397.html](https://bigsoundbank.com/cicada-1-long-s2397.html) | CC0 1.0 |
...
| BodyHeartbeat | Heart Beat #4 | Joseph Sardin | [bigsoundbank.com/heart-beat-4-s1929.html](https://bigsoundbank.com/heart-beat-4-s1929.html) | CC0 1.0 |
| BodyBreathing | Man Breathing | Joseph Sardin | [bigsoundbank.com/man-breathing-s2195.html](https://bigsoundbank.com/man-breathing-s2195.html) | CC0 1.0 |

This started as three textures (Water, Rain, Wind); Water and Wind were dropped and Rain expanded to six surfaces once the project became rain-specific. Birds, Insects and Body (the last a lower-confidence experiment) were added after that as further banks -- see CHANGELOG.md and NOTES.md for that history.
...
1. Trimmed to an excerpt from a point that avoided obvious handling noise or scene changes at the recording's start/end (exact offsets: rain +3s, puddle +5s, concrete +5s, terrace +30s, tarpaulin +10s, wheelbarrow +20s, forest +5s, birds waking +30s, evening birds +30s, nocturnal insects +30s, cicada +10s, crickets/frogs +60s, heartbeat +2s, breathing +5s). Rain and Birds clips are 8 seconds; Insects and Body are 6 seconds, trimmed shorter specifically to fit the remaining flash budget once four banks existed.
